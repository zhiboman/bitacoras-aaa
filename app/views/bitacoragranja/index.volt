<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="/bitacoras-aaa/bitacoragranja"class="btn btn-primary active">Buscar Bitacora Granjas</a></li>
      <li><a href="/bitacoras-aaa/bitacoragranja/new">Crear Bitacora Granjas</a></li>
...
{{ form("bitacoragranja/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
